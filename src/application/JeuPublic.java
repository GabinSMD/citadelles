...
public class JeuPublic {
	...
	public int[] nombrePoints = {0,0,0,0};
	public int[] pointsCoutConstruction = {0,0,0,0};
	public int[] pointsNombreType = {0,0,0,0};
	public int[] pointsCiteTermine = {0,0,0,0};
	public int[] pointsMerveille = {0,0,0,0};
